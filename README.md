...
Simple and extensible SSD1306 OLED 128x64 display driver for ESP32 written in C++ using ESP-IDF. It handles I2C bus and the display through easy to work with SSD1306Driver object.
...
I also added a python script ConvertToSSD1306.py which will convert any `.gif/.mp4/.png/.jpg/.jpeg/.webp` into a format you can directly display on the screen
